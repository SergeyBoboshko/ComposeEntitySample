...
@Entity(tableName = "rep_utilitypayments_settings")
@ObjectGeneratorCE(type = GeneratorType.Report,label="Balance/Overpayment", generationLevel = GenerationLevel.UI, hasDetails = true, detailsEntityClass = AccumRegMyPayments::class)
