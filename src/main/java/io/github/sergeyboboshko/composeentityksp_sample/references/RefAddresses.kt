...
data class RefAddressesEntity(
    ...
    @CeField(onChange = "RefAddressHelper.showZip",  label = "@@zipCode_label", type = FieldTypeHelper.NUMBER, placeHolder = "@@zipCode_placeholder", positionOnForm = 5,
        condition = "RefAddressHelper.zipCondition", renderInList = false)
    var zipCode: String,
    @CeField(render=true, label = "@@city_label", type = FieldTypeHelper.TEXT, placeHolder = "@@city_placeholder", positionOnForm = 4, useForOrder = true,
        condition = "RefAddressHelper.cityCondition")
    var city:String,
    @CeField(onEndEditing = "RefAddressHelper.showAddress", label = "@@address_label", type = FieldTypeHelper.TEXT, placeHolder = "@@address_placeholder", positionOnForm = 2, useForOrder = true)
    var address:String,
    @CeField(render=true, label = "@@houseNumber_label", type = FieldTypeHelper.NUMBER, placeHolder = "@@houseNumber_placeholder", positionOnForm = 3, useForOrder = true, renderInList = false)
    var houseNumber: Int,
    @CeField(render=true, label = "@@houseBlock_label", type = FieldTypeHelper.TEXT, placeHolder = "@@houseBlock_placeholder", positionOnForm = 1, renderInList = false)
